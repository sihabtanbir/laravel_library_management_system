...
<form action="/login" method="POST">
  @csrf
    <div class="space-y-12">
      <div class=" p-4   border-1 w-[450px] mx-auto bg-white shadow-lg pl-10 rounded-md">
          ...
          <div class="sm:col-span-4 pl-4">
            ...
            <div class="mt-2">
              <div class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                ...
                <input type="password" name="password" id="password" class="block w-[500px]  py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="******">
              </div>
              @error('password')
              <p class="text-sm text-red-400">{{$message}}</p>
          @enderror
